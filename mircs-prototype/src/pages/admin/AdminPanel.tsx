...
// REQ-0238: Licensing Authority Report for Expired Licenses
// REQ-0215: Harassment Orders — denial/suspension/revocation letter reasons
...
const INITIAL_MESSAGES: AdminMessage[] = [
  { id: '1', target: 'Unified Portal Landing Page', message: 'IMPORTANT: The Massachusetts Electronic Firearms Registry is now live as of October 2, 2025.', active: true, created: '2025-10-02' },
...
const EXPIRED_LICENSES = [
  { name: 'Wilson, Gary', licenseNo: 'LTC-00991', type: 'LTC', expires: '2025-01-15', town: 'Boston', inRenewal: false },
  { name: 'Taylor, Susan', licenseNo: 'FID-44321', type: 'FID', expires: '2025-02-20', town: 'Boston', inRenewal: true },
  { name: 'Martin, Kevin', licenseNo: 'LTC-55678', type: 'LTC', expires: '2025-03-01', town: 'Boston', inRenewal: false },
];
    ...
    <div>
      ...
      <div className="steps" style={{ marginBottom: '1.5rem' }}>
        {[
          ...
          <button key={tab.id} className={`step ${activeTab === tab.id ? 'active' : ''}`}
        ...
        <div>
          <div className="card">
            ...
            <div className="form-group">
              ...
              <textarea className="form-control" rows={3} value={newMessage} onChange={e => setNewMessage(e.target.value)}
      ...
      {/* REQ-0238: Expired Licenses Report for LA */}
      {activeTab === 'expired' && (
        <div className="card">
          <div className="card-title">Expired Licenses — Boston Police Department</div>
          <p style={{ color: '#616161', fontSize: '0.875rem', marginBottom: '1rem' }}>
            Licenses issued to residents of your jurisdiction that have expired. Licenses with an active
            renewal application in progress are excluded or flagged accordingly.
          </p>
          <div className="table-container">
            <table>
              <thead>
                <tr><th>Name</th><th>License No.</th><th>Type</th><th>Expired</th><th>Renewal Pending</th><th>Actions</th></tr>
              </thead>
              <tbody>
      ...
      {/* REQ-0215: Denial/Suspension/Revocation Reasons */}
      {activeTab === 'denial-reasons' && (
        <div className="card">
          <div className="card-title">Manage Denial / Suspension / Revocation Reasons</div>
          <p style={{ color: '#616161', fontSize: '0.875rem', marginBottom: '1rem' }}>
            These reference values populate the denial, suspension, and revocation letter reason dropdowns
            throughout Core MIRCS. Per REQ-0215, harassment orders (M.G.L. c.258E §4A–4C) have been added.
          </p>
          <div className="table-container">
            <table>
          ...
          <div className="btn-group">
            <button className="btn btn-primary btn-sm">+ Add Reason</button>
          </div>
        </div>
      )}
    </div>
