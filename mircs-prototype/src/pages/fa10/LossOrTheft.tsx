// REQ-0014 / REQ-0016: Capture Loss or Theft City/Town & State
      ...
      <div>
        ...
        <div className="card confirmation-page">
          ...
          <p style={{ color: '#616161', marginBottom: '1rem' }}>
            Your report has been submitted and your licensing authority has been notified.
          </p>
          <div className="confirmation-ticket">
            <strong>Report No.:</strong> LT-2025-{Math.floor(Math.random() * 900000 + 100000)}<br />
          ...
          <div className="alert alert-info" style={{ maxWidth: 500, margin: '1rem auto', textAlign: 'left' }}>
            <strong>ℹ️ Next Steps:</strong> Your licensing authority and DCJIS have been automatically
            notified. You may be contacted for additional information. Please also file a police report
  ...
  return (
    <div>
      ...
      <div className="alert alert-warning">
        <strong>⚠️ Required:</strong> Massachusetts law requires all lost or stolen firearms to be
        reported electronically. Upon submission, your licensing authority will be automatically notified
        per M.G.L. c.140 §121B(c).
      </div>
      ...
      <div className="card">
        ...
        <div className="form-row-3">
          ...
          {/* REQ-0016: City/Town & State — if out of state, show city/town field */}
          <div className="form-group">
          ...
          <div className="form-group">
            <label className="form-label">
              {lossState !== 'MA' ? 'City/Town (Out of State)' : 'City/Town'} <span className="required-mark">*</span>
            </label>
            <input type="text" className="form-control" value={lossCity} onChange={e => setLossCity(e.target.value)}
              placeholder={lossState !== 'MA' ? 'Enter out-of-state city' : 'Enter city/town'} />
          </div>
        </div>
        <div className="form-group">
          <label className="form-label">Circumstances / Description</label>
          <textarea className="form-control" rows={3} value={circumstance} onChange={e => setCircumstance(e.target.value)}
